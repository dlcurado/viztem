...
CREATE POLICY "Delete apenas pelo dono" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'anuncios'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "Fotos públicas para leitura" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'anuncios'::"text"));



CREATE POLICY "Upload apenas pelo dono" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'anuncios'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));
